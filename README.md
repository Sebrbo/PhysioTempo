...
- Les fichiers principaux mis en cache incluent `index.html`, `css/style.css`, `js/app.js`, le manifeste et les icones.
- Installation :
...
- Cached core files include `index.html`, `css/style.css`, `js/app.js`, the manifest, and icons.
- Install:
