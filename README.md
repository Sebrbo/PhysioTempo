...
- Les fichiers principaux mis en cache incluent `index.html`, `css/style.css`, le script applicatif versionne `js/app.js?v=2026-06-29-v24`, le manifeste et les icones.
- Installation :
...
- Cached core files include `index.html`, `css/style.css`, the versioned app script `js/app.js?v=2026-06-29-v24`, the manifest, and icons.
- Install:
