...
- Le cache courant du service worker est `physiotempo-v26`.
- Les fichiers principaux mis en cache incluent `index.html`, le CSS versionne `css/style.css?v=2026-06-30-v26`, le script applicatif versionne `js/app.js?v=2026-06-30-v25`, le manifeste et les icones.
- Installation :
...
- The current service worker cache is `physiotempo-v26`.
- Cached core files include `index.html`, the versioned CSS `css/style.css?v=2026-06-30-v26`, the versioned app script `js/app.js?v=2026-06-30-v25`, the manifest, and icons.
- Install:
